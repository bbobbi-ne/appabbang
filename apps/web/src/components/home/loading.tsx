...
function MainLoading() {
  ...
  return (
    <>
      ...
      <div className="ml-[16%] mr-[16%]  px-1 gap-2 flex flex-row items-center justify-center">
        {arr.map((_, i) => (
      ...
      <div className="grid grid-cols-3 grid-rows-1 h-40 ml-[16%] mr-[16%] gap-10 mb-28 ">
        <Card className="p-5">
          <Skeleton className="h-6 w-40 mb-4" />
